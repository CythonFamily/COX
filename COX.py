...
B='\033[94m'
N = '\x1b[0m' # WARNA MATI
USN="Mozilla/5.0 (Linux; Android 7.0; HUAWEI NMO-L31 Build/HUAWEINMO-L31; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/65.0.3325.109 Mobile Safari/537.36 Instagram 37.0.0.21.97 Android (24/7.0; 480dpi; 1080x1812; HUAWEI; HUAWEI NMO-L31; HWNMO-H; hi6250; en_US; 98288242)"
...
[00] Instagram Exit 
	...
	def ua_ran(self):
		...
		xp='Instagram {}.0.0.{}.{} Android ({}/{}; 480dpi; 1080x1812; HUAWEI; HUAWEI NMO-L31; HWNMO-H; hi6250; en_US; 98288242)'.format(self.anc,self.apc,self.abc,self.xyz,self.Android_Version(andro),ponid)
		return random.choice([xp])
	def vers(self):
		igv=("81.0.0.15.91,81.0.0.15.91,71.0.0.18.102,71.0.0.18.102,81.0.0.15.91,71.0.0.18.102,81.0.0.15.91,71.0.0.18.102")
		igve=igv.split(",")
